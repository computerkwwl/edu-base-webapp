...
[@b.grid items=students var="student"]
  ...
  [@b.row]
    ...
    [@b.col width="15%" property="grade" title="年级"]${(student.state.grade)!}[/@]
    [@b.col width="15%" property="major" title="专业"]${(student.state.major.name)!}[/@]
    [@b.col width="10%" property="department" title="院系"]${(student.state.department.name)!}[/@]
