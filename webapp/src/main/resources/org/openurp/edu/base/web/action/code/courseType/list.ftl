...
[@b.grid items=courseTypes var="courseType"]
  ...
  [@b.row]
    ...
    [@b.col width="15%" property="theoretical" title="是否实践课"]${(courseType.practical?string("是","否"))!}[/@]
    [@b.col width="15%" property="beginOn" title="生效时间"]${courseType.beginOn!}[/@]
    [@b.col width="15%" property="endOn" title="失效时间"]${courseType.endOn!}[/@]
  [/@]
[/@]
[@b.foot/]
